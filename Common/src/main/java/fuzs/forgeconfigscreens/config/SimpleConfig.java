...
public class SimpleConfig {
    ...
    static {
        final Pair<SimpleConfig, ForgeConfigSpec> clientSpecPair = new ForgeConfigSpec.Builder().configure(SimpleConfig::new);
        CLIENT_SPEC = clientSpecPair.getRight();
        CLIENT = clientSpecPair.getLeft();
        final Pair<SimpleConfig, ForgeConfigSpec> commonSpecPair = new ForgeConfigSpec.Builder().configure(SimpleConfig::new);
        COMMON_SPEC = commonSpecPair.getRight();
        COMMON = commonSpecPair.getLeft();
        final Pair<SimpleConfig, ForgeConfigSpec> serverSpecPair = new ForgeConfigSpec.Builder().configure(SimpleConfig::new);
