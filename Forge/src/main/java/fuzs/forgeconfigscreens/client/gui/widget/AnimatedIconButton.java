...
public class AnimatedIconButton extends MutableIconButton {
    private final int origXTexStart;
    private int tickTime;
    private int frames;
    private int speed;

    public AnimatedIconButton(int x, int y, int width, int height, int xTexStart, int yTexStart, ResourceLocation resourceLocation, Button.OnPress onPress) {
