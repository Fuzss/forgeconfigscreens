...
public class IconButton extends Button {
    ...
    public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTicks) {
        ...
        this.blit(poseStack, this.getX, this.y, 0, 46 + index * 20, this.width / 2, this.height);
        this.blit(poseStack, this.getX + this.width / 2, this.y, 200 - this.width / 2, 46 + index * 20, this.width / 2, this.height);
        this.renderBg(poseStack, minecraft, mouseX, mouseY);
        RenderSystem.setShader(GameRenderer::getPositionTexShader);
        RenderSystem.setShaderTexture(0, this.resourceLocation);
        blit(poseStack, this.getX, this.y, this.xTexStart, this.yTexStart + index * this.yDiffTex, this.width, this.height, this.textureWidth, this.textureHeight);
