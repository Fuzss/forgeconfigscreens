...
public class ScreenUtil {
    private static final ResourceLocation TINY_JUMPER_LOCATION = new ResourceLocation(ForgeConfigScreensFabric.MOD_ID, "textures/gui/tiny_jumper.png");
    private static final Component INFO_1_TOOLTIP = new TranslatableComponent("configmenusforge.gui.info.1");
    private static final Component INFO_2_TOOLTIP = new TranslatableComponent("configmenusforge.gui.info.2", ForgeConfigScreensFabric.MOD_NAME);
    ...
    public static AnimatedIconButton makeModPageButton(int posX, int posY, Font font, Consumer<Style> handleComponentClicked, ITooltipRenderer renderTooltip) {
        return new AnimatedIconButton(posX, posY, 20, 20, 0, 0, TINY_JUMPER_LOCATION, button -> {
            Style style = Style.EMPTY.withClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, ForgeConfigScreensFabric.MOD_URL));
